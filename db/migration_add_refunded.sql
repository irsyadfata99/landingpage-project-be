-- ==========================================
-- MIGRATION: Add REFUNDED status to orders
-- Jalankan setelah migration_add_expired.sql
-- ==========================================
...
-- 2. Tambah constraint baru dengan REFUNDED
ALTER TABLE orders
  ADD CONSTRAINT orders_status_check
  CHECK (status IN ('PENDING','PAID','PROCESSING','SHIPPED','DELIVERED','DONE','EXPIRED','REFUNDED'));

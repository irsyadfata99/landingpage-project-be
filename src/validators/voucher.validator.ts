...
// Base schema tanpa refine — bisa di-.partial()
const createVoucherBaseSchema = z.object({
  code: z
    .string()
...
// Create schema dengan refine
export const createVoucherSchema = createVoucherBaseSchema.refine(
  (data) => {
...
// Update schema pakai base (partial, tanpa refine)
